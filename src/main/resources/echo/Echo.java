...
public final class Echo {
  ...
  public static final class EchoRequest extends
    ...
    public static final class Builder extends
       ...
       implements echo.Echo.EchoRequestOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return echo.Echo.internal_static_echo_EchoRequest_descriptor;
      }
  ...
  public static final class EchoResponse extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return echo.Echo.internal_static_echo_EchoResponse_descriptor;
    }

    protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return echo.Echo.internal_static_echo_EchoResponse_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              echo.Echo.EchoResponse.class, echo.Echo.EchoResponse.Builder.class);
    }
    ...
    public static echo.Echo.EchoResponse parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static echo.Echo.EchoResponse parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static echo.Echo.EchoResponse parseFrom(
    ...
    public static echo.Echo.EchoResponse parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseFrom(input);
    }
    public static echo.Echo.EchoResponse parseFrom(
    ...
    public static echo.Echo.EchoResponse parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input);
    }
    public static echo.Echo.EchoResponse parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return PARSER.parseDelimitedFrom(input, extensionRegistry);
    ...
    public static Builder newBuilder() { return Builder.create(); }
    public Builder newBuilderForType() { return newBuilder(); }
    public static Builder newBuilder(echo.Echo.EchoResponse prototype) {
      return newBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() { return newBuilder(this); }
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessage.Builder<Builder>
       implements echo.Echo.EchoResponseOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return echo.Echo.internal_static_echo_EchoResponse_descriptor;
      }
      ...
      // Construct using echo.Echo.EchoResponse.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      public echo.Echo.EchoResponse getDefaultInstanceForType() {
        return echo.Echo.EchoResponse.getDefaultInstance();
      }

      public echo.Echo.EchoResponse build() {
        echo.Echo.EchoResponse result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public echo.Echo.EchoResponse buildPartial() {
        echo.Echo.EchoResponse result = new echo.Echo.EchoResponse(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof echo.Echo.EchoResponse) {
          return mergeFrom((echo.Echo.EchoResponse)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(echo.Echo.EchoResponse other) {
        if (other == echo.Echo.EchoResponse.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        echo.Echo.EchoResponse parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (echo.Echo.EchoResponse) e.getUnfinishedMessage();
          throw e;
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "equest\032\022.echo.EchoResponse"
    };
