...
public abstract class AbstractNonblockingServer extends TServer {
	...
	public class FrameBuffer {
		...
		public FrameBuffer(final TNonblockingTransport trans,
			...
			outTrans_ = outputTransportFactory_
					.getTransport(new TIOStreamTransport(response_));
		...
		public void invoke() {
			...
			try {
				...
				processorFactory_.getProcessor(inTrans_).process(inProt_,
						outProt_);
				responseReady();
				return;
			} catch (TException te) {
	...
	public class AsyncFrameBuffer extends FrameBuffer {
		public AsyncFrameBuffer(TNonblockingTransport trans,
				SelectionKey selectionKey, AbstractSelectThread selectThread) {
		...
		public void invoke() {
			...
			try {
				...
				((TBaseAsyncProcessor) processorFactory_.getProcessor(inTrans_))
						.process(this);
				return;
			} catch (TException te) {
				LOGGER.warn("Exception while invoking!", te);
